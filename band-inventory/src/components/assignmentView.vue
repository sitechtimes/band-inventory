<template>
  <div>
    <div v-if="instrumentStore.assignmentAll" class="mx-8 mt-8">
      <div class="p-6 mt-6 mr-4">
        ...
        <div
          v-if="
            !detailStore?.assignments || detailStore.assignments.length === 0
          "
        ...
        >
          ...
          <p class="font-semibold">
            Adding assignments to your instruments will help you keep track of
        ...
        <div v-else class="space-y-4">
          ...
          <div
            v-if="detailStore.assignments.length > 3"
...
async function closeAssignment() {
  if (detailStore.shownInstrument != undefined) {
    await detailStore.closeAssignment(
      ...
      detailStore.shownInstrument.serial_model,
    );
  }
