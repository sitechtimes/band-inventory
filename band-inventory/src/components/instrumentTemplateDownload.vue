...
const downloadTemplate = async () => {
  try {
    ...
    const noteRow = worksheet.addRow([
      "Notes: The first two rows are examples. Please remove them and add your own data. Set assignment to null for now and then add any assignments on the instrument details page. DELETE THIS NOTE BEFORE UPLOADING PLEASE.",
    ]);
