<template>
  <div
    class="inputContainer flex flex-col bg-deep-blue rounded-lg m-2 border-1"
  >
    <div
      class="inputFields flex flex-wrap gap-y-1.5 gap-x-1.5 bg-light-blue rounded-lg p-2 md:pb-8 border-1"
    >
      <filterCategories
        :title="'category'"
        :id="'category'"
