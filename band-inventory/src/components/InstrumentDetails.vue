    ...
    <div v-if="detailStore.shownInstrument" class="mx-6 mt-6">
        ...
        <div class="flex flex-col md:flex-row">
            <div class="w-full md:w-1/3">
                <h3 class="mt-2 italic border border-gray-300 border-b-0 p-2 bg-gray-50">Details</h3>
                <div class="border border-gray-300 p-4 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
            ...
            <div class="w-full md:w-1/3 mt-4 md:mt-0">
                <h3 class="mt-2 italic border border-gray-300 border-b-0 p-2 bg-gray-50 md:border-l-0">Identifiers</h3>
                <div class="border border-gray-300 p-4 grid grid-cols-1 sm:grid-cols-2 gap-6 md:border-l-0">
                    <div>
            ...
            <div class="w-full md:w-1/3 mt-4 md:mt-0">
                <h3 class="mt-2 italic border border-gray-300 border-b-0 p-2 bg-gray-50 md:border-l-0">Value Details</h3>
                <div class="border border-gray-300 p-4 grid grid-cols-1 sm:grid-cols-2 gap-6 md:border-l-0">
                    <div>
