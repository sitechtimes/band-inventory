        ...
        <div class="shadow-sm rounded-sm gap-x-4">
            <div class="grid @max-md:grid-rows-2 md:grid-cols-2">
                <div class="flex flex-col m-2 md:ml-4">
                    ...
                    <input type="date" class="input w-7/8 focus:border-green" v-model="repairData.repair_date"
                        required />
                </div>
                <div class="flex flex-col m-2 md:ml-4">
                    <label>Repair Needed</label>
                    <input type="text" class="input w-7/8 focus:border-green" v-model="repairData.repair_needed"
                        placeholder="What type of repair?" required />
                </div>
                <div class="flex flex-col m-2 md:ml-4">
                    <label>Requested By</label>
                    <input type="text" class="input w-7/8 focus:border-green" v-model="repairData.requested_by"
                        placeholder="Who requested the repair?" required />
                </div>
                <div class="flex flex-col m-2 md:ml-4">
                    <label>Repair Notes</label>
                    <input type="text" class="input w-7/8 focus:border-green" v-model="repairData.repair_notes"
                        placeholder="Description" />
                </div>
                <div class="flex flex-col m-2 md:ml-4">
                    <label>Completion Status</label>
                    <select v-model="repairData.completed" class="input w-7/8 focus:border-green" required>
            ...
            <div>
                <button class="btn mx-2 md:ml-4 my-4 align-self-center bg-deep-green text-white" @click="addRepair">
                    Add Repair
                </button>
